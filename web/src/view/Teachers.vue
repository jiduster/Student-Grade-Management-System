            ...
            <Col span="16" offset="4">
                <Row>
                    <Col span="6" style="text-align: left;">
                        <a href="javascript:void(0)" @click="this.$router.push('/students')">Student Grade Management</a>
                    </Col>
                ...
                <Row>
                    <Col offset="10">
                        <Button type="primary" @click="get_list"> Inquire List </Button>
                    </Col>
                    <Col offset="1">
    ...
    <div>
        <Modal
            ...
            <p>
                ...
                <Row style="margin-top: 10px">
                    ...
                    <Col span="18"> <Input  v-model="add.param.password" size="small" style="width: 80%" /> </Col>
                </Row>
            </p>
        </Modal>
        ...
        <Modal
            ...
            <p>
                ...
                <Row style="margin-top: 10px">
                    <Col span="6"> Password </Col>
                    <Col span="18"> <Input  v-model="modify.param.password" size="small" style="width: 80%" /> </Col>
                </Row>
            </p>
        </Modal>
    </div>
    ...
    methods: {
        get_list(){
            ...
            this.$axios({
                ...
                method: "GET",         // 请求方式
                url: import.meta.env.VITE_API_BASE_HOST + "/teacher_list", // 本地的学生信息
        ...
        add_ok(){
            ...
            let param = {name:this.add.param.name, password:''}
            ...
            this.$axios({
                ...
                url: import.meta.env.VITE_API_BASE_HOST + "/teacher_add", // 本地的学生信息
                headers:{
                ...
                this.$Message.success("Account has been added successfully!")
                this.add.loading = false
                this.$nextTick(()=>{
                    this.add.loading = true
                })
        ...
        del_submit(id){
            ...
            this.$axios({
                ...
                method: "POST",         // 请求方式
                data: JSON.stringify(param),
                url: "http://127.0.0.1:9000/teacher_del", // 本地的学生信息
                headers:{
                    'Content-Type': "application/json"
                },
            }).then((res)=>{        // 下面这一堆是处理网断的情况下可能发生的异常
                ...
                this.$Message.success("Account has been deleted successfully!")
        ...
        modify_ok(){
            ...
            let param = {
                ...
                password: this.modify.param.password
            }
            ...
            this.$axios({
                ...
                method: "POST",         // 请求方式
                data: JSON.stringify(param),
                url: import.meta.env.VITE_API_BASE_HOST + "/teacher_modify", // 本地的学生信息
                headers:{
                    'Content-Type': "application/json"
                },
            }).then((res)=>{        // 下面这一堆是处理网断的情况下可能发生的异常
                ...
                this.$Message.success("Account has been modified successfully!")
                this.modify.loading = false
                this.$nextTick(()=>{
                    this.modify.loading = true
                })
        ...
        show_modify(row){
            ...
            this.modify.param.password = row.password
        },
